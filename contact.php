...
$conn =mysqli_connect('localhost','root','','information_db');
if(isset($_POST['send'])){
...
$insert ="INSERT INTO `information_db`(`name`, `email`, `number`, `plan`, `message`, `destination`, `hotel`, `decorators`, `makeup`, `photographers`, `designers`, `event`) VALUES (' $name','$email','$number','$plan','$message','$destination','$hotel','$decorators','$makeup','$photographers','$designers','$events')";
